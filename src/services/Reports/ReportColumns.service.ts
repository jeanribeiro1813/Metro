...
import Reportes_PiloteRepository from '../../typeorm/repositories/ReportesPilotesRepository';

class ReporteColumnsService {

    public async show(): Promise<Reportes_Pilote[] | undefined> {

        const loadService = getCustomRepository(Reportes_PiloteRepository);
...
export default ReporteColumnsService;